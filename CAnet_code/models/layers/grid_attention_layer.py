...
from RJH_Nucleus_seg.models.networks_other import init_weights
...
class MultiAttentionBlock_3D(nn.Module):
    def __init__(self, in_size, gate_size, inter_size, nonlocal_mode, sub_sample_factor):
        super(MultiAttentionBlock_3D, self).__init__()
...
if __name__ == '__main__':
    ...
    for mode in mode_list:
        ...
        net = GridAttentionBlock3D(in_channels=16, inter_channels=16, gating_channels=64, mode=mode, sub_sample_factor=2)
